...
func (cmd *Commands) Help(s *discordgo.Session, m *discordgo.Message, ctx *Context) {
	if len(ctx.Fields) == 0 {
		...
		defaultHelp.Footer = &discordgo.MessageEmbedFooter{Text: fmt.Sprintf("Requested by: %s | made by https://github.com/Crashoutt", m.Author.Username)}
	...
	certainHelp.Footer = &discordgo.MessageEmbedFooter{Text: fmt.Sprintf("Requested by: %s | made by https://github.com/Crashoutt", m.Author.Username)}
...
func (cmd *Commands) Setup(s *discordgo.Session, m *discordgo.Message, ctx *Context) {
	...
	s.ChannelMessageSendEmbed(m.ChannelID, &discordgo.MessageEmbed{
		...
		Fields: []*discordgo.MessageEmbedField{
			...
			{Name: "Support:", Value: "If you need any help, click [here](https://github.com/Crashoutt"},
		},
		Color: 0x36393F,
	})
